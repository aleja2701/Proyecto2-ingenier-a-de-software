...
export const PatientIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ResultsIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2.75 12.75a9 9 0 0 1 18.5 0" /><path d="M12 12v8.25" /><path d="M12 21.25h-1.5" /><path d="M13.5 21.25H12" /><path d="M16 16.5c.5-.5.5-1 0-1.5h-1.5" /><path d="M8 15c-.5.5-.5 1 0 1.5h1.5" /><path d="m15 12-3-3-3 3" />
  </svg>
);
